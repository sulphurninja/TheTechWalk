...
const PostCard = ({ post }) => (
  <div className="bg-[#C049A4] shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
    ...
    <div className="block lg:flex text-center items-center justify-center mb-8 w-full">
      <div className="flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8 items-center">
        <Image
          ...
          src={post.author.authorPic.url}
        />
        <p className="inline align-middle text-purple-800 ml-2 font-medium text-lg">{post.author.aythorName}</p>
      </div>
